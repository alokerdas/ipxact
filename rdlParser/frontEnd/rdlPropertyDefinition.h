...
class RDLPropertyDefinition : public RDLBase
{
  ...
  typedef enum {
    ...
    RDL_PROPERTY_COMPONENT_CONSTRAINT = 32,
    RDL_PROPERTY_COMPONENT_ALL = 64
  ...
  typedef enum {
    ...
    RDL_PROPERTY_TYPE_BIT,
    RDL_PROPERTY_TYPE_MEM,
    RDL_PROPERTY_TYPE_LONGINT,
    RDL_PROPERTY_TYPE_LONGINT_UNSIGN,
    RDL_PROPERTY_TYPE_UNSIGN,
    RDL_PROPERTY_TYPE_NUMBER,
    RDL_PROPERTY_TYPE_BOOLEAN,
    RDL_PROPERTY_TYPE_USER
